        ...
        <el-row>
          ...
          >
            ...
            <audio ref="music" loop>
              <source
                src="http://ex.sycdn.kuwo.cn/937c49367ffdbd06268ec5ca7e63a682/5fb78af0/resource/n2/26/38/2583562187.mp3"
                type="audio/mpeg"
              />
            </audio>
          </el-col>
          <el-col :span="4" style="text-align: right;">
            ...
            <div style="color:#606266;">
              <i class="el-icon-location"></i>&nbsp;fuzhou
              <br />
            </div>
          </el-col>
          <el-col :span="2" style="text-align: center;">
            ...
            <el-popover
              ...
              trigger="hover"
            >
              <i class="el-icon-star-on"></i>&emsp;辣子鸡
              <br />
              <i class="el-icon-location"></i>&emsp;fuzhou
              <br />
              <img
                src="https://avatars0.githubusercontent.com/u/30425217?v=4"
